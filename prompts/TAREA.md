...
| Instrucción | Crea un programa de consola para registrar objetos perdidos de estudiantes. Debe tener un menú para registrar, listar, buscar objetos y salir. Guarda cada objeto en una lista de diccionarios con descripción, lugar y fecha; |
| Contexto    | de estudiantes                                                                                                                                                                                                                 |
